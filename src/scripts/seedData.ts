...
const adminEmail = env.adminEmail || "admin@demo.com";
const adminPassword = env.adminPassword || "Admin123!";
const adminName = env.adminName || "Demo Admin";
const storeId = env.demoStoreId || "demo-store-001";
...
const customers = [
  {
    ...
    address: "112 Oak Street, Seattle, WA",
  },
  {
    name: "Daniel Brooks",
    email: "daniel.brooks@example.com",
    phone: "+1-202-555-0142",
    address: "48 Market Avenue, Austin, TX",
  },
  {
    name: "Ayesha Khan",
    email: "ayesha.khan@example.com",
    phone: "+1-202-555-0143",
    address: "77 Lakeview Drive, Chicago, IL",
  },
  {
    name: "Luis Martinez",
    email: "luis.martinez@example.com",
    phone: "+1-202-555-0144",
    address: "9 Palm Court, Miami, FL",
  },
  {
    name: "Priya Sharma",
    email: "priya.sharma@example.com",
    phone: "+1-202-555-0145",
    address: "305 Pine Road, Denver, CO",
  },
];
...
const seed = async () => {
  ...
  const [productCount, customerCount, taskCount] = await Promise.all([
    Product.countDocuments({ store_id: admin.storeId || storeId }),
  ...
  if (productCount || customerCount || taskCount) {
    console.log("Seed skipped: demo products, customers, or tasks already exist.");
    return;
  }
  ...
  await Product.insertMany(
    products.map((product) => ({
      ...product,
      store_id: admin.storeId || storeId,
      createdBy: admin._id,
